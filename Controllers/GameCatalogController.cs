    ...
    public IActionResult Games()
        => Ok(new
        {
            ...
            games = new[]
            {
                ...
                new { id = "deal_or_no_deal", name = "Deal or No Deal", description = "Coming soon.", enabled = true, image = "/assets/Games/deal.png"},
                new { id = "hangman", name = "Hangman", description = "Coming soon.", enabled = true, image = "/assets/Games/hangman.png"},
