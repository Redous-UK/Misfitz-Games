    ...
    public IActionResult Games()
        => Ok(new
        {
            ...
            games = new[]
            {
                ...
                new { id = "hangman", name = "Hangman", description = "Guess the hidden word one letter at a time. Too many wrong guesses and it’s game over!", enabled = true, image = "/assets/Games/hangman.png"},
