    ...
    public IActionResult Games()
        => Ok(new
        {
            ...
            games = new[]
            {
                ...
                new { id = "twenty_one", name = "21", description = "Coming soon.", enabled = true, image = "/assets/Games/21.png"},
                ...
                new { id = "riddles", name = "Riddle Me This", description = "Riddle me this! Can you solve the riddles and puzzles we throw at you?", enabled = true, image = "/assets/Games/riddles.png"},
